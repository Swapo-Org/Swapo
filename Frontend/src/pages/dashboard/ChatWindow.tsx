    ...
    <div className="flex flex-1 flex-col bg-stone-50 dark:bg-gray-900">
      <div className="mb-17 flex flex-col justify-between">
        <div>
          ...
          {/* Messages */}
          <div className="hide-scrollbar-vertical mb-12 flex flex-1 flex-col space-y-3 overflow-y-auto px-4 py-4">
        ...
        <div className="fixed bottom-[58px] z-50 mx-auto flex w-full max-w-lg items-center space-x-2 border-t border-b border-gray-200 bg-stone-50 px-2 py-2 dark:border-gray-700 dark:bg-gray-900">
